  ...
  useEffect(() => {
    ...
    function moveSlider(direction) {
      ...
      const thumbnailItems =
        thumbnailElement.querySelectorAll(".thumbnail .item");
        ...
        <div className="list">
          ...
          <div className="item">
            ...
            <div className="content">
              ...
              <div className="description text-white">
                The Taj Mahal, located in Agra, India, is an iconic symbol of
                love built by Mughal Emperor Shah Jahan in memory of his wife
                Mumtaz Mahal. This white marble mausoleum is known for its
                exquisite beauty and architectural perfection.
              </div>
          ...
          <div className="item">
            ...
            <div className="content">
              ...
              <div className="description text-white">
                India Gate, situated in New Delhi, is a war memorial honoring
                the soldiers who sacrificed their lives during World War I.
                Designed by Sir Edwin Lutyens, it stands as a symbol of bravery
                and valor.
              </div>
              <div className="button">
                <button>SEE MORE</button>
          ...
          <div className="item">
            ...
            <div className="content">
              ...
              <div className="description text-white">
                Hawa Mahal, or the "Palace of Winds," is located in Jaipur,
                Rajasthan. Built by Maharaja Sawai Pratap Singh, this pink
                sandstone structure is famous for its unique design, with
                numerous small windows allowing royal women to observe street
                festivities.
              </div>
              <div className="button">
                <button>SEE MORE</button>
          ...
          <div className="item">
            ...
            <div className="content">
              ...
              <div className="description text-white">
                The Konark Sun Temple, located in Odisha, India, is an
                architectural marvel dedicated to the Hindu sun god Surya. Built
                in the 13th century by King Narasimhadeva I, it is known for its
                chariot-shaped design and intricate carvings.
              </div>
              <div className="button">
                <button>SEE MORE</button>
              </div>
