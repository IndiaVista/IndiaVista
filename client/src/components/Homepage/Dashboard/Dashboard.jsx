...
import { MapPin, Calendar, Camera, BarChart3, Plus, Edit2, Trash2, Eye } from "lucide-react";
import { useNavigate } from "react-router-dom";
import NavBar from "../navbar.jsx";
import Footer from "../../Landing_Page/Footer.jsx";
import { apiConnector } from "../../../services/apiConnector.js";
import { endpoints, iternaryEndpoints } from "../../../services/apis.js";
...
export default function Dashboard() {
  ...
  const handleDeleteConfirm = async () => {
    try {
      setLoading(true);
      await apiConnector("DELETE", `${iternaryEndpoints.DELETE_ITINERARY}/${selectedItinerary._id}`);
      
      // Update the itineraries list after successful deletion
      setItineraries(prevItineraries => 
        prevItineraries.filter(itinerary => itinerary._id !== selectedItinerary._id)
      );
      ...
      setError(err.response?.data?.message || err.message || "Error deleting itinerary");
      setLoading(false);
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-md w-full">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Are you sure you want to delete "{selectedItinerary?.iternaryName}"? This action cannot be undone.
            </p>
