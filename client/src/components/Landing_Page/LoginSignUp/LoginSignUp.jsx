    ...
    <div className="relative min-h-screen flex items-center justify-center bg-cover bg-center" 
      ...
      {/* Other component code */}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <input
              ...
              />
              <div onClick={togglePassword} className="absolute cursor-pointer flex items-center z-[5] mt-[-1.8rem] ml-[22rem]">
        ...
        <div className="mt-6 text-center text-sm">
          <span className="text-gray-400">{isregister ? "Already a user?" : "Dont't have an account?"} </span>
          <a className="text-blue-400 cursor-pointer hover:underline" onClick={switchMode}>{isregister ? "  Sign In" : "  Register"}</a>
        </div>
